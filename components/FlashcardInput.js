...
export default function FlashcardInput({ onSubmit, initialTopic, initialMaterial }) {
      ...
      <div className="card max-w-2xl mx-auto">
        <div className="text-center mb-6">
          <div className="w-16 h-16 bg-primary-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <i className="bi bi-card-checklist text-3xl text-primary-600"></i>
          </div>
          <h2 className="text-xl font-bold text-gray-900">Buat Flashcard</h2>
          <p className="text-gray-600 text-sm mt-2">
            Masukkan topik untuk membuat kartu belajar interaktif.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Jelaskan secara detail materi yang ingin dibuat flashcard-nya..."
              rows={5}
            ...
            <div className="flex flex-wrap gap-2">
              {suggestions.map((s) => (
                <button
                  ...
                  onClick={() => {
                    setTopic(s)
                    setMaterial(`Buatkan flashcard tentang ${s.toLowerCase()}. Setiap kartu harus memiliki pertanyaan di satu sisi dan jawaban di sisi lainnya.`)
                  }}
